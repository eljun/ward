...
5. Run: python3 ${CLAUDE_PLUGIN_ROOT}/scripts/brain.py with event="recap", the extracted content in context, and mode="state" to generate updated state.json fields.
...
7. Run: python3 ${CLAUDE_PLUGIN_ROOT}/scripts/speak.py with a 1-2 sentence spoken summary of what was found — top priority, tasks in progress count, pending PRs if any.
